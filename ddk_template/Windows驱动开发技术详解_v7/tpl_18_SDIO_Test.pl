...
$tpl_input_dir="tpl_18_SDIO_Test";
$tpl_output_dir="output/tpl_18_SDIO_Test"."_".$Name;
...
$template->process($tpl_input_dir."/function.h.tpl", $vars, "$tpl_output_dir//function.h") || die $template->error();
...
$template->process($tpl_input_dir."/function.cpp.tpl", $vars, "$tpl_output_dir//function.cpp") || die $template->error();
