...
$tpl_input_dir="tpl_09_irpSync_AsyncOperate2";
$tpl_output_dir="output/tpl_09_irpSync_AsyncOperate2"."_".$Name;
...
$template->process($tpl_input_dir."/test.dat.tpl", $vars, "$tpl_output_dir//test.dat") || die $template->error();
