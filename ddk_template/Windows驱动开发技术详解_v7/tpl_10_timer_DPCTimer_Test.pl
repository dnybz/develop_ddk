...
$tpl_input_dir="tpl_10_timer_DPCTimer_Test";
$tpl_output_dir="output/tpl_10_timer_DPCTimer_Test"."_".$Name;
...
$template->process($tpl_input_dir."/NT_Driver/Ioctls.h.tpl", $vars, "$tpl_output_dir//NT_Driver/Ioctls.h") || die $template->error();
